---
name: scitex-cv
description: Small cv2-based image utilities. I/O (load/save/color-convert), transform (resize/rotate/flip/crop/pad), filters (blur/sharpen/edge/threshold/denoise), draw (rectangle/circle/line/text/polylines/arrow). Drop-in replacement for memorising cv2's BGR-vs-RGB swaps and dtype quirks.
